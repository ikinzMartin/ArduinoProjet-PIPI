...
void init_io(void)
{
  digitalWrite(IRQ, 0);  //interrupt signal:In wireless communication, MCU communicates with NRF24L01 by IRQ.
  digitalWrite(CE, 0);	 // chip enable :If CSN is low, CE together with the CONFIG register of NRF24L0A determine the state of NRF24L01.
  digitalWrite(CSN, 1);  // chip select，active at low level	
}
